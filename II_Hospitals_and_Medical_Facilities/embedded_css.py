...
#layout-row, #input-card, #result-card,
#symptoms, #age, #pain_scale, #duration, #run_btn, #clear_btn,
#triage, #diagnosis, #care_plan, #reasoning, #footer {
    will-change: opacity, transform;
    backface-visibility: hidden;
}

/* Keep deterministic pre-animation state until JS marks html.anim-ready */
html:not(.anim-ready) #hero,
html:not(.anim-ready) .hero-eyebrow,
html:not(.anim-ready) .hero-title,
html:not(.anim-ready) .hero-sub,
html:not(.anim-ready) #layout-row,
html:not(.anim-ready) #input-card,
html:not(.anim-ready) #result-card,
html:not(.anim-ready) #symptoms,
html:not(.anim-ready) #age,
html:not(.anim-ready) #pain_scale,
html:not(.anim-ready) #duration,
html:not(.anim-ready) #run_btn,
html:not(.anim-ready) #clear_btn,
html:not(.anim-ready) #triage,
html:not(.anim-ready) #diagnosis,
html:not(.anim-ready) #care_plan,
html:not(.anim-ready) #reasoning,
html:not(.anim-ready) #footer {
    opacity: 0;
    transform: translate3d(0, 18px, 0);
}

html:not(.anim-ready) .hero-rule {
    opacity: 0;
}
...
/* =============================================
   STABLE ID-BASED FALLBACKS (GRADIO 5+ SAFE)
   ============================================= */

#hero {
    background: linear-gradient(160deg, var(--green-900) 0%, var(--green-700) 55%, var(--green-500) 100%) !important;
}
